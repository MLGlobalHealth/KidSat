...
def main(fold, model_name, target, imagery_path, imagery_source, emb_size, batch_size, num_epochs, img_size = None):
    ...
    best_model = f'modelling/dino/model/{model_name}ms_van_{fold}_all_cluster_best_{imagery_source}{target}_.pth'
    last_model = f'modelling/dino/model/{model_name}ms_van_{fold}_all_cluster_last_{imagery_source}{target}_.pth'
